    ...
    public class FastLineRenderer : MonoBehaviour
    {
        ...
        private void ApplyListsToMeshes()
        {
            ...
            for (int index = 0; index <= listIndex; index++)
            {
                ...
                MeshRenderer r2 = meshRenderersNoGlow[index];
                r.enabled = r2.enabled = true;
                r.sharedMaterial = Material;
                r2.sharedMaterial = MaterialNoGlow;
                r.sortingLayerName = r2.sortingLayerName = SortLayerName;
                r.sortingOrder = r2.sortingOrder = SortOrderInLayer;
            }
        }
        ...
        private void UpdateMaterial()
        {
            ...
            UpdateMaterial(Material, meshRenderers, materialNoGlowPropertyBlock, GlowTexture, GlowTextureStartCap, GlowTextureEndCap, GlowTextureRoundJoin, GlowColor, GlowAnimationSpeed, new Vector2(GlowUVXScale, GlowUVYScale));
        }
