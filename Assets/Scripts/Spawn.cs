...
public class Spawn : MonoBehaviour
{
	...
	void Start()
	{
		System.IO.StreamReader file = new System.IO.StreamReader(@"./Assets/galaxies-small.txt");
		// System.IO.StreamReader file = new System.IO.StreamReader(@"./Assets/galaxies" + (bigSet ? "-large" : "") + ".txt");
